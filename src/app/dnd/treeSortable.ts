...
declare global {
  interface JQuery {
    ...
    updateBranchLevel(current: number, prev?: any): JQuery;
    shiftBranchLevel(dx: number): JQuery;
    getParent(): JQuery;
    getRootChild(): JQuery;
    getLastChild(): JQuery;
    getChildren(): JQuery;
    sortable(x: any): JQuery;
    getDescendants(): JQuery;
    nextBranch(): JQuery;
    prevBranch(): JQuery;
    nextSibling(): JQuery;
    prevSibling(): JQuery;
    getLastSibling(): JQuery;
    getSiblings(level?: any): JQuery;
    calculateSiblingDistances(): void;
  }
}
...
export const getDistance = (elementA, elementB) => {
...
export function TreeSortable(options) {
    ...
    this.addChildBranch = function ($triggerElement) {
        ...
        const $lastChild = $branch.getLastChild();
    ...
    this.addSiblingBranch = function ($triggerElement) {
        ...
        while ($lastChild.length) {
            const $temp = $lastChild.getLastChild();
    ...
    this.removeBranch = function ($triggerElement) {
        ...
        const $branch = $triggerElement.closest(`${treeSelector} ${branchSelector}`);
        const $descendants = $branch.getDescendants();
